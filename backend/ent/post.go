...
type PostEdges struct {
	...
	Saves []*SavedPost `json:"saves,omitempty"`
...
func (e PostEdges) AuthorOrErr() (*Profile, error) {
	if e.Author != nil {
		return e.Author, nil
...
// was not loaded in eager-loading.
func (e PostEdges) SavesOrErr() ([]*SavedPost, error) {
	if e.loadedTypes[3] {
		return e.Saves, nil
	}
...
// was not loaded in eager-loading.
func (e PostEdges) MediaOrErr() ([]*PostMedia, error) {
	if e.loadedTypes[4] {
		return e.Media, nil
	}
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case post.FieldID, post.FieldAuthorID, post.FieldBody:
...
func (_m *Post) QueryAuthor() *ProfileQuery {
...
func (_m *Post) QueryLikes() *PostLikeQuery {
	return NewPostClient(_m.config).QueryLikes(_m)
}

// QuerySaves queries the "saves" edge of the Post entity.
func (_m *Post) QuerySaves() *SavedPostQuery {
	return NewPostClient(_m.config).QuerySaves(_m)
}

// QueryMedia queries the "media" edge of the Post entity.
func (_m *Post) QueryMedia() *PostMediaQuery {
	return NewPostClient(_m.config).QueryMedia(_m)
}
