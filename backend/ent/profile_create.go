...
func (_c *ProfileCreate) SetClerkSubject(v string) *ProfileCreate {
	_c.mutation.SetClerkSubject(v)
	return _c
}

// SetDisplayName sets the "display_name" field.
func (_c *ProfileCreate) SetDisplayName(v string) *ProfileCreate {
...
func (_c *ProfileCreate) AddPostIDs(ids ...string) *ProfileCreate {
	_c.mutation.AddPostIDs(ids...)
	return _c
}

// AddPosts adds the "posts" edges to the Post entity.
func (_c *ProfileCreate) AddPosts(v ...*Post) *ProfileCreate {
...
func (_c *ProfileCreate) AddCommentIDs(ids ...string) *ProfileCreate {
	_c.mutation.AddCommentIDs(ids...)
	return _c
}

// AddComments adds the "comments" edges to the Comment entity.
func (_c *ProfileCreate) AddComments(v ...*Comment) *ProfileCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProfileCreate) AddLikeIDs(ids ...string) *ProfileCreate {
	_c.mutation.AddLikeIDs(ids...)
	return _c
}

// AddLikes adds the "likes" edges to the PostLike entity.
func (_c *ProfileCreate) AddLikes(v ...*PostLike) *ProfileCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProfileCreate) AddSavedPostIDs(ids ...string) *ProfileCreate {
	_c.mutation.AddSavedPostIDs(ids...)
	return _c
}

// AddSavedPosts adds the "saved_posts" edges to the SavedPost entity.
func (_c *ProfileCreate) AddSavedPosts(v ...*SavedPost) *ProfileCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSavedPostIDs(ids...)
}
...
func (_c *ProfileCreate) check() error {
	if _, ok := _c.mutation.ClerkSubject(); !ok {
		return &ValidationError{Name: "clerk_subject", err: errors.New(`ent: missing required field "Profile.clerk_subject"`)}
	}
	if v, ok := _c.mutation.ClerkSubject(); ok {
		if err := profile.ClerkSubjectValidator(v); err != nil {
			return &ValidationError{Name: "clerk_subject", err: fmt.Errorf(`ent: validator failed for field "Profile.clerk_subject": %w`, err)}
		}
	}
...
func (_c *ProfileCreate) createSpec() (*Profile, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ClerkSubject(); ok {
		_spec.SetField(profile.FieldClerkSubject, field.TypeString, value)
	...
	if nodes := _c.mutation.SavedPostsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
